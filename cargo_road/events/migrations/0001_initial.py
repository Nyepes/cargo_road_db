# Generated by Django 4.1.1 on 2022-09-09 21:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Cargo',
            fields=[
                ('shipment', models.PositiveIntegerField(blank=True, primary_key=True, serialize=False)),
                ...
                ('fuel_surcharge', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10)),
                ('tolls_surcharge', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10)),
                ('dhpu', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10)),
                ('empty_income', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10)),
                ('t_check_advance', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10)),
                ('traded_value', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10)),
                ('detention', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10)),
